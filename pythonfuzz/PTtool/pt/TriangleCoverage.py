...
from pt.BoundaryTriangle import BoundaryTriangle
...
class BaseTriCoverage(TriangleCoverage):
    ...
    def cal_triangle_cov(self, Tx, Ty, n, deep_num, by_deep_num=True):
        if by_deep_num:
            cov, var, cov_num_arr_list,no_cov_num_arr_list = self.cal_cov_fine(Tx, Ty, n, deep_num)
            return (cov, var, cov_num_arr_list,no_cov_num_arr_list)
        else:
    ...
    def cal_cov_fine(self, Tx_prob_matrix, Ty, n, deep_num):
        ...
        for i in range(n):
            ...
            if Tx_prob_matrixc_i.size == 0:
                ...
                no_cov_num_arr_list.append([0] * deep_num)
                continue
            ...
            for deep_num_ix in range(deep_num):
                ...
                no_cov_num_arr.append((4 ** (deep_num_ix + 1) * len(pq_list)) - total_cov_len)
            ...
            no_cov_num_arr_list.append(no_cov_num_arr)
        ...
        return (cov_rate_arr, cov_var_arr, cov_num_arr_list,no_cov_num_arr_list)
