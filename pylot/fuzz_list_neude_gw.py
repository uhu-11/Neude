import sys
import os
import neude.neude.config_neude as config_neude
config_neude.NEUDE_METHOD = 'neude_gw'
sys.modules['neude.config'] = config_neude
sys.modules['neude.neude.config'] = config_neude
