...
def process_images_and_json(image_dir, json_dir, copy_path):
    ...
    start_index = json_files.index('tl-bboxes-00084095.json')
...
def main():
    # 指定目录路径
    i=4
    image_dir = f'/home/lzq/experiment_datatset/all_gathered_dataset/town{i}/traffic-light'
    json_dir = f'/home/lzq/experiment_datatset/all_gathered_dataset/town{i}/tl-bboxes'
    copy_path=f'/home/lzq/experiment_datatset/fuzz_test_dataset/town{i}/traffic_light_dataset_datax'
    # 读取所有json文件
    ...
    print("\nFirst few files:")
    # print(json_data)
    np.save(f'/home/lzq/experiment_datatset/fuzz_test_dataset/town{i}/light_y.npy', json_data)
...
def process_images_and_json(image_dir, json_dir, copy_path):
    ...
    # 找到 'bboxes-00223348.json' 的索引
    start_index = json_files.index('bboxes-00413548.json')
...
#     # 指定目录路径
#     i=5
#     image_dir = f'/home/lzq/experiment_datatset/all_gathered_dataset/town{i}/center'
#     json_dir = f'/home/lzq/experiment_datatset/all_gathered_dataset/town{i}/bboxes'
#     copy_path=f'/home/lzq/experiment_datatset/fuzz_test_dataset/town{i}/obstacles_dataset_datax'
#     # 读取所有json文件
#     json_data = process_images_and_json(image_dir,json_dir,copy_path)
...
#     print("\nFirst few files:")
#     # print(json_data)
#     np.save(f'/home/lzq/experiment_datatset/fuzz_test_dataset/town{i}/obstacles_y.npy', json_data)
# if __name__ == "__main__":
